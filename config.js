...
const CONFIG = {
  ...
  business: {
    name:      "Dalapros",
    phone:     "+27 71 793 7244",
    whatsapp:  "+27 71 793 7244",
    address:   "28 1st Rd, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Dalapros — Construction in randburg",
    description: "Dalapros provides professional construction in Randburg. 22 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Construction · Randburg & surrounds",
    heroTitle:  "Quality construction work — <em>on time, done right.</em>",
    heroLead:   "Dalapros handles residential and commercial construction, renovations and general contracting across Randburg. From a single room renovation to a full build.",
    ...
    band: {
      ...
      alt:   "Dalapros team at work in Randburg",
      text:  "Quality construction work, delivered on time and on budget."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Working across Randburg and the wider area.",
    areasLead:  "We take on residential and commercial projects across Randburg, Northcliff, Cresta and surrounding areas.",
